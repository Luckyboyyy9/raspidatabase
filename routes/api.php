...
Route::prefix('relational-read')->group(function () {
    Route::get('/eloquent/{author_id}', [RelationalReadController::class, 'getRelationalDataWithEloquent'])->name('relational.read.eloquent');
    Route::get('/query-builder/{author_id}', [RelationalReadController::class, 'getRelationalDataWithQueryBuilder'])->name('relational.read.queryBuilder');
